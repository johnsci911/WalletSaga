<div class="flex flex-col items-center max-w-7xl mx-auto py-6">
    <h1 class="text-3xl font-bold text-blue-600 text-center">Expense Tracker</h1>

    <!-- Earning and Expense Forms -->
    <div class="flex justify-between mb-4 py-5 space-x-8 w-1/2">
        <form wire:submit.prevent="submitEarning" class="flex flex-col bg-gray-50 p-4 rounded-xl w-full space-y-4">
    ...
    <!-- Budget Table -->
    <table class="w-full border-collapse table-auto zebra rounded-lg bg-gray-200">
        <style>
            .expense-row {
        ...
        <tbody>
            ...
            @endif
            <tr>
                <th colspan="4" class="px-4 py-2 text-right">Balance</th>
